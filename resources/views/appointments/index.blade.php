    ...
    <div class="col-sm-12 col-mobile">
        <div class="board-box">
            <div class="board-title">
                <h2>List of all appointments <a href="{{ route('appointments.create') }}" class="add-new-employee"><span  style="float: right;padding-right: 20px;" class="fa fa-plus"></span></a></h2>
            </div>
            ...
            <div class="table-style">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($appointments as $appointment)
                            <tr>
                                ...
                                <td><button class="btn btn-default btn-lg" onclick='window.location.href="{{ route('appointments.show',$appointment->id) }}"'>
                ...
                <nav aria-label="Page navigation" class="my-pagination">
                    {!! str_replace('/?', '?', $appointments->render()) !!}
                </nav>
            </div>
        </div>
    </div>
